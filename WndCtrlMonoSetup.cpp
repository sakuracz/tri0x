...
namespace Win{
	...
	bool MonoWndCtrl::OnCreate(CreateData const* create)
	{
		...
		::SetWindowPos(_hwnd, NULL, (maxX - width) / 2, (maxY - height) / 2, 175, 200, SWP_SHOWWINDOW);
		...
		::SetWindowPos(_staticArr[2]->GetHandle(), NULL, 10, 90, 65, 20, SWP_SHOWWINDOW);
